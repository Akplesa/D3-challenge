...
//   //Creating Y scales
//       var yLinearScale = d3.scaleLinear()
//       .domain([d3.min(HealthcareData, d => d[chosenYAxis]) * 0.8,
//         d3.max(HealthcareData, d => d[chosenYAxis]) * 2.8
//       ])
//       .range([height, 0]);
...
//     } else {YLinearScale(d.healthcare);}
//   })
//   .text(function(d) {
//     return d.abbr;
//   })
...
// var SmokesPercentageLable = YlabelsGroup.append("text")
// .attr("transform", "rotate(-90)")
// .attr("y", 0 - margin.left)
// .attr("x", 0 - (height / 3))
// .attr("dy", "1em")
...
// var LacksHealthcarePercentageLable = YlabelsGroup.append("text")
// .attr("transform", "rotate(-90)")
// .attr("y", 0 - margin.left)
// .attr("x", 0 - (height / 4))
// .attr("dy", "1em")
